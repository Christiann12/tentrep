<div class="reviewPage">
    <div class="banner">
        <p class="greeting"><?= $vetData->clinicName ?></p>
        <p class="content">Location:<span class='notbold'><?= $vetData->address.', '.$vetData->region.', '.$vetData->province.', '.$vetData->municipality.', '.$vetData->barangay ?></span></p>
    </div>
    <div class="section1">
        <p class="header m-0">How was your experience in this place?</p>
        <?php echo form_open_multipart('Pages/Review/saveReview') ?>
            ...
            <div class="form-label-group d-none">
                ...
                <input name="vetId" type="text" id="vetId" class="inputDesign form-control" placeholder="VetId" value="<?php echo !empty($vetData) ? $vetData->vetId : null ?>">
            </div>
            <div class="form-label-group mt-5">
