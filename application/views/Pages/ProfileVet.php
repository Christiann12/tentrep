<div class="profileVet">
    <div class="design" <?php echo $userData->clinicpicture != 'empty' ? 'style="background: url('.base_url('application/assets/images/clinicpicture/'.$userData->clinicpicture).'); background-size: cover; background-repeat: no-repeat;  background-position: center;"  ' : 'style="background: url('.base_url('application/assets/images/customerbackground.png').'); background-size: cover; background-repeat: no-repeat;  background-position: center;"  ' ; ?>>
            ...
            <?php echo form_open_multipart('Common/RegistrationCustomer/saveUser') ?>
                ...
                <div class="row">
                    ...
                    <div class="col-6 form-label-group">
                        ...
                        <input readonly name="userId" type="text" id="userId" class="inputDesign form-control" placeholder="User Id" value="<?php echo !empty($userData) ? $userData->vetId : null ?>">
                    </div>
                </div>
            <?php echo form_close() ?>
        </div>
    ...
    <div class="section2">
        ...
        else if($userData->region == 'region' || $userData->province == 'province' || $userData->municipality == 'municipality' || $userData->barangay == 'barangay' || $userData->address == 'address' || $userData->clinicName == 'clinic name' || $userData->desc == 'description'){
            ...
            <?php echo form_open_multipart('Common/RegistrationCustomer/saveUser') ?>
                ...
                <div class="w-100">
                    ...
                    <div class="form-label-group">
                        ...
                        <input readonly name="clinicName" type="text" id="clinicName" class="inputDesign form-control" placeholder="Clinic Name" value="<?php echo !empty($userData) ? $userData->clinicName : null ?>">
                    </div>
