<div class="editProfileSeller">
    ...
    <div class="section1">
        ...
        <div class="userform m-0">
             ...
             <!-- RESULT NOTIFICATION  -->
            <?php if($this->session->flashdata('successEditSeller')){ ?>
                <div class="alert alert-success mt-3" > 
                    <?php  echo $this->session->flashdata('successEditSeller'); $this->session->unset_userdata ( 'successEditSeller' );?>
                </div>
            <?php } ?>  
            <?php if ($this->session->flashdata('failEditSeller')){ ?>
                <div class="alert alert-danger mt-3" > 
                    <?php  echo $this->session->flashdata('failEditSeller'); $this->session->unset_userdata ( 'failEditSeller' );?>
                </div>
            <?php } ?>
            
            <?php echo form_open_multipart('Pages/EditProfileSeller/saveEditUserInformation') ?>
            ...
            <?php echo form_close() ?>
            <?php echo form_open_multipart('Pages/EditProfileSeller/saveEditStoreInformation') ?>
                ...
                <div class="form-label-group mt-3">
                    <label for="storepicture" class="labelDesign mt-3">Change Store Picture: </label>
                    <input type="file" name="storepicture" id="storepicture" class="">
                </div> 
