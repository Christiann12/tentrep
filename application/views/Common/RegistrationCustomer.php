        ...
        <div class="primaryContainer" style="background: url(<?php echo base_url('application/assets/images/loginbackground.png')?>); background-repeat: no-repeat; background-size: cover; background-blend-mode: darken;">
            <div class="registrationPanel">
                <center>
                    ...
                    <p class="subtitle2 mt-5">Sign Up as Customer</p>
                </center>
                <?php echo form_open_multipart('Common/RegistrationCustomer/saveUser') ?>
                    ...
                    <div class="m-auto w-50">
                        ...
                        <!-- RESULT NOTIFICATION  -->
                        <?php if($this->session->flashdata('successCustomerCreate')){ ?>
                            <div class="alert alert-success" > 
                                <?php  echo $this->session->flashdata('successCustomerCreate'); $this->session->unset_userdata ( 'successCustomerCreate' );?>
                            </div>
                        <?php } ?>  
                        <?php if ($this->session->flashdata('errorCustomerCreate')){ ?>
                            <div class="alert alert-danger" > 
                                <?php  echo $this->session->flashdata('errorCustomerCreate'); $this->session->unset_userdata ( 'errorCustomerCreate' );?>
                            </div>
                        <?php } ?>
