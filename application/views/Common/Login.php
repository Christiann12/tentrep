...
<html>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>application/assets/css/Common/Login.css"/>
        ...
        <div class="primaryContainer" style="background: url(<?php echo base_url('application/assets/images/loginbackground.png')?>); background-repeat: no-repeat; background-size: cover; background-blend-mode: darken;">
            <div class="loginPanel">
                <center>
                    ...
                    <p class="subtitle2 mt-5">Login</p>
                </center>
                <?php echo form_open_multipart('Common/Login/checkUser') ?>
                    ...
                    <div class="m-auto spacing1" style="width: 50%;">
                        ...
                        <div class="form-label-group">
                            <input name="userNameLogin" type="text" id="userNameLogin" class="form-control" placeholder="User Name">
                            <label for="userNameLogin" class="">User Name</label>
                        </div>
