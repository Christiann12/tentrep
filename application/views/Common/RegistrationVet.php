        ...
        <div class="primaryContainer" style="background: url(<?php echo base_url('application/assets/images/loginbackground.png')?>); background-repeat: no-repeat; background-size: cover; background-blend-mode: darken;">
            <div class="registrationPanel">
                <center>
                    ...
                    <p class="subtitle2 mt-5">Sign Up as Veterenarian</p>
                </center>
                <?php echo form_open_multipart('Common/RegistrationVet/saveUser') ?>
                    <div class="m-auto w-50">

                         <!-- RESULT NOTIFICATION  -->
                         <?php if($this->session->flashdata('successVetCreate')){ ?>
                            <div class="alert alert-success" > 
                                <?php  echo $this->session->flashdata('successVetCreate'); $this->session->unset_userdata ( 'successVetCreate' );?>
                            </div>
                        <?php } ?>  
                        <?php if ($this->session->flashdata('errorVetCreate')){ ?>
                            <div class="alert alert-danger" > 
                                <?php  echo $this->session->flashdata('errorVetCreate'); $this->session->unset_userdata ( 'errorVetCreate' );?>
                            </div>
                        <?php } ?>
