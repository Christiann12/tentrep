...
<head>
    ...
    <link href="<?php echo base_url('application/assets/starrating//css/star-rating.css')?>" media="all" rel="stylesheet" type="text/css"/>
    <!--suppress JSUnresolvedLibraryURL -->
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    <script src="<?php echo base_url('application/assets/starrating/js/star-rating.js')?>" type="text/javascript"></script>
<body>
<div class="container">
